...
const Nbo = () => {
  return (
    <svg className='size-28' xmlns="http://www.w3.org/2000/svg" height="800" width="1200" viewBox="-63.3 -43.5 548.6 261">
      ...
      <circle r="65" cy="87" cx="335" fill="none" stroke="#666E6D" strokeWidth="44"/>
      <circle r="35" cy="87" cx="335" fill='#e4e4e4'/>
      </svg>
  )
}
